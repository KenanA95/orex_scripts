...
# the location of the pincipal point (place where the optical axis pierces the image plane)
...
ncmodel = BrownModel(focal_x=focal_x, focal_y=focal_y, princpoint_x=princ_point_x, field_of_view=fov,
                     ...
                     # set some information for the calibration.  use_priori indicates whether to perform an update
                     # fit of the data (True) or to restimate the fit from scratch (False) and estimation_parameters
